                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <x-adminlte-select id="dependencia" name="dependencia" label="Dependencia"  required>
                                            ...
                                            @foreach ($dependencias as $item2)
                                                <option value="{{ $item2->id }}" @if ($item2->id==$item->dependencia) selected @endif>{{ $item2->dependencia }} </option>                                                
                                            @endforeach
                                        </x-adminlte-select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <x-adminlte-select id="turnoReg" name="turnoReg" label="Turno Regulador"  required>
                                            <option value="{{ $item->turno_reg}}" >@if($item->turno_reg==1)Primer turno @endif</option>
                                        </x-adminlte-select>
                                    </div>
                                    <div class="col-2">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <x-adminlte-select id="tipo" name="tipo" label="Tipo de averia" required>
                                            ...
                                            @foreach ($averias as $item3)
                                            <option value="{{ $item3 -> tipo }}">{{ $item3 -> tipo }}.- {{ $item3 -> descripcion }}</option>   
                                            @endforeach                    
                                        </x-adminlte-select>
                                    </div>
                                    <div class="col">
